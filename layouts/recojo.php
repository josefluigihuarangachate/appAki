                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                            <strong>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control InputNumberNoChange" readonly="readonly" style="text-align: center;" min="0" value="0" id="dia1" name="dia1">
                                    <input type="hidden" hidden="hidden" class="form-control InputNumberNoChange" readonly="readonly" min="0" value="0" id="realdia1" name="realdia1">
                    ...
                    <p class="mb-1" style="width: 100% !important;">
                        <strong>
                            ...
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    <input type="date" class="form-control" readonly="readonly" ref="" placeholder="FECHA" value="" id="fec1" name="fec1" onchange="cambiardefecha(1);">
                                    <input type="date" hidden="hidden" class="form-control" readonly="readonly" placeholder="FECHA" value="" id="realfec1" name="realfec1">
                                </div>
                            </div>
                        </strong>
                    </p>
                            ...
                            <div class="card-body">            
                                    ...
                                    <div class="col-6">
                                        <strong>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" class="form-control InputNumberNoChange" readonly="readonly" style="text-align: center;" min="0" value="0" id="dia` + numOrden + `" name="dia` + numOrden + `">
                                                <input type="hidden" hidden="hidden" class="form-control InputNumberNoChange" readonly="readonly" min="0" value="0" id="realdia` + numOrden + `" name="realdia` + numOrden + `">
                                                <div class="input-group-append">
                                ...
                                <p class="mb-1" style="width: 100% !important;">
                                    <strong>
                                        ...
                                        <div class="form-group basic">
                                            <div class="input-wrapper">
                                                <input type="date" class="form-control" readonly="readonly" ref="" placeholder="FECHA" value="" id="fec` + numOrden + `" name="fec` + numOrden + `" onchange="cambiardefecha(` + numOrden + `);">
                                                <input type="date" hidden="hidden" class="form-control" readonly="readonly" placeholder="FECHA" value="" id="realfec` + numOrden + `" name="realfec` + numOrden + `">
                                            </div>
                                        </div>
                                    </strong>
                                </p>

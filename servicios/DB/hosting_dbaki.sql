...
-- Tiempo de generación: 13-10-2021 a las 21:51:48
...
--
-- Base de datos: `u460301108_dbaki`
--
...
(1, NULL, 6, 3647, 1, 'Tarde', '2021-10-13', '15:00:00', 'Sin Atender', 'Recojo', NULL, NULL, NULL);
...
--
ALTER TABLE `color`
  MODIFY `id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4784;
...
--
ALTER TABLE `marca`
  MODIFY `id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1870;
